...
Create a file named _.env_ inside of _Inksac_Data_.
...
To start the backend run the following command in the root directory **WITH THE VENV ACTIVATED**: `uvicorn Inksac.main:app`

To start the frontend, open a new terminal and cd into _Inksac-Web_.
